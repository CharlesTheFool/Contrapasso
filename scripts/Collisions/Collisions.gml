...
function check_collision(_move_x, _move_y) 
{
	...
	// collisions, at each corner of the instance's bounding box.
	// This checks for tile collision at the top-left corner of the instance's mask
	_left_top = tilemap_get_at_pixel(obj_game_manager.collision_tilemap2, bbox_left + _move_x, bbox_top + _move_y);

	// This checks for tile collision at the top-right corner of the instance's mask
	_right_top = tilemap_get_at_pixel(obj_game_manager.collision_tilemap2, bbox_right + _move_x, bbox_top + _move_y);

	// This checks for tile collision at the bottom-right corner of the instance's mask
	_right_bottom = tilemap_get_at_pixel(obj_game_manager.collision_tilemap2, bbox_right + _move_x, bbox_bottom + _move_y);

	// This checks for tile collision at the bottom-left corner of the instance's mask
	_left_bottom = tilemap_get_at_pixel(obj_game_manager.collision_tilemap2, bbox_left + _move_x, bbox_bottom + _move_y);
